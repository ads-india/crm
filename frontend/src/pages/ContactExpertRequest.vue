...
const { document: medicineOrder } = useDocument('Yorecare Enquiry', props.contactExpertRequestId)

const breadcrumbs = computed(() => {
  let items = [{ label: __('Contact Expert Requests'), route: { name: 'Contact Expert Requests' } }]
  ...
  items.push({
    label: title.value,
    route: { name: 'Contact Expert Request', params: { contactExpertRequestId: props.contactExpertRequestId } },
  })
  return items
})
...
const title = computed(() => {
  ...
  return medicineOrder.doc?.[t] || props.contactExpertRequestId
})
