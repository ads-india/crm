<template>
  <LayoutHeader>
    <template #left-header>
      <ViewBreadcrumbs v-model="viewControls" routeName="Yorecare Logs" />
    </template>
...
import YorecareLogsListView from '@/components/ListViews/YorecareLogsListView.vue'
import KanbanView from '@/components/Kanban/KanbanView.vue'
import YorecareLogModal from '@/components/Modals/YorecareLogModal.vue'
