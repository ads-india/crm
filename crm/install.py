...
def add_default_fields_layout(force=False):
	quick_entry_layouts = {
		...
		"Yorecare Enquiry-Quick Entry": {
			...
			"layout": '[{"label":"Yorecare Quick Entry","name":"yorecare_quick_entry_section","opened":true,"columns":[{"name":"column_main","fields":["crm_lead","user_name","phone_number","age","gender","source","type","pincode","prescription","details","medicine_order_status","comparison_link"]}]}]'
		},
	}
	...
	sidebar_fields_layouts = {
		...
		"Yorecare Enquiry-Side Panel": {
			"doctype": "Yorecare Enquiry",
			"layout": '[{"label":"Details","name":"details_section","opened":true,"columns":[{"name":"column_details","fields":["crm_lead","user_name","phone_number","age","gender","source","type","pincode","prescription","details","medicine_order_status","comparison_link"]}]}]'
		},
	}
